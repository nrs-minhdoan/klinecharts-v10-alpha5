...
exports.TooltipFeatureType = void 0;
(function (TooltipFeatureType) {
    TooltipFeatureType["Path"] = "path";
    TooltipFeatureType["IconFont"] = "icon_font";
})(exports.TooltipFeatureType || (exports.TooltipFeatureType = {}));
exports.TooltipFeaturePosition = void 0;
...
})(exports.TooltipFeaturePosition || (exports.TooltipFeaturePosition = {}));
...
var IndicatorImp = /** @class */ (function () {
    function IndicatorImp(indicator) {
        ...
        this.visible = true;
        this.zLevel = 0;
        this.series = exports.IndicatorSeries.Normal;
        this.figures = [];
        this.minValue = null;
        this.maxValue = null;
        this.styles = null;
...
var OverlayImp = /** @class */ (function () {
    function OverlayImp(overlay) {
        ...
        this.mode = exports.OverlayMode.Normal;
...
var StoreImp = /** @class */ (function () {
    ...
    StoreImp.prototype._adjustVisibleRange = function () {
        ...
        this.executeAction(exports.ActionType.OnVisibleRangeChange, this._visibleRange);
        this._visibleRangeDataList = [];
        this._visibleRangeHighLowPrice = [
            { x: 0, price: Number.MIN_SAFE_INTEGER },
            { x: 0, price: Number.MAX_SAFE_INTEGER }
    ...
    StoreImp.prototype.scroll = function (distance) {
        ...
        if (realDistance !== 0) {
            this.executeAction(exports.ActionType.OnScroll, { distance: realDistance });
        }
    };
    ...
    StoreImp.prototype.zoom = function (scale, coordinate) {
        ...
        if (realScale !== 1) {
            this.executeAction(exports.ActionType.OnZoom, { scale: realScale });
        }
    };
    ...
    function IndicatorTooltipView() {
        ...
        _this._boundFeatureClickEvent = function (currentFeatureInfo) { return function () {
            ...
            if (isValid(indicator)) {
                ...
                pane.getChart().getChartStore().executeAction(exports.ActionType.OnCandleTooltipFeatureClick, currentFeatureInfo);
            }
            return true;
        }; };
    ...
    IndicatorTooltipView.prototype.drawStandardTooltipFeatures = function (ctx, features, coordinate, indicator, left, prevRowHeight, maxWidth) {
        ...
        if (features.length > 0) {
            ...
            features.forEach(function (feature) {
                ...
                var contentWidth = 0;
                if (type === exports.TooltipFeatureType.IconFont) {
    ...
    IndicatorTooltipView.prototype.classifyTooltipFeatures = function (features) {
        ...
        features.forEach(function (feature) {
            switch (feature.position) {
                case exports.TooltipFeaturePosition.Left: {
                    leftFeatures.push(feature);
                    break;
                }
                case exports.TooltipFeaturePosition.Middle: {
                    middleFeatures.push(feature);
                    break;
                }
                case exports.TooltipFeaturePosition.Right: {
...
var OverlayView = /** @class */ (function (_super) {
    ...
    OverlayView.prototype._coordinateToPoint = function (o, coordinate) {
        ...
        if (this.coordinateToPointValueFlag()) {
            ...
            if (o.mode !== exports.OverlayMode.Normal && paneId === PaneIdConstants.CANDLE && isNumber(point.dataIndex)) {
                var kLineData = chartStore.getDataByDataIndex(point.dataIndex);
                if (kLineData !== null) {
                    var modeSensitivity = o.modeSensitivity;
                    if (value > kLineData.high) {
                        if (o.mode === exports.OverlayMode.WeakMagnet) {
...
var CandleTooltipView = /** @class */ (function (_super) {
    ...
    CandleTooltipView.prototype._getCandleTooltipLegends = function () {
        ...
        var mapping = {
            '{time}': customApi.formatDate(current.timestamp, 'YYYY-MM-DD HH:mm', exports.FormatDateType.Tooltip),
    ...
    OverlayXAxisView.prototype.getDefaultFigures = function (overlay, coordinates) {
        ...
        if (overlay.needDefaultXAxisFigure && overlay.id === ((_a = clickOverlayInfo.overlay) === null || _a === void 0 ? void 0 : _a.id)) {
            ...
            coordinates.forEach(function (coordinate, index) {
                ...
                var point = overlay.points[index];
                if (isNumber(point.timestamp)) {
                    var text = chartStore.getCustomApi().formatDate(point.timestamp, 'YYYY-MM-DD HH:mm', exports.FormatDateType.Crosshair);
...
var CrosshairVerticalLabelView = /** @class */ (function (_super) {
    ...
    CrosshairVerticalLabelView.prototype.getText = function (crosshair, chartStore) {
        ...
        return chartStore.getCustomApi().formatDate(timestamp, 'YYYY-MM-DD HH:mm', exports.FormatDateType.Crosshair);
    };
                    ...
                    if (timeWeightTick.dataIndex >= start && timeWeightTick.dataIndex < realTo) {
                        ...
                        switch (weight) {
                            case TimeWeightConstants.Year: {
                                text = formatDate(timestamp, 'YYYY', exports.FormatDateType.XAxis);
                                break;
                            }
                            case TimeWeightConstants.Month: {
                                text = formatDate(timestamp, 'YYYY-MM', exports.FormatDateType.XAxis);
                                break;
                            }
                            case TimeWeightConstants.Day: {
                                text = formatDate(timestamp, 'MM-DD', exports.FormatDateType.XAxis);
                                break;
                            }
                            case TimeWeightConstants.Hour:
                            case TimeWeightConstants.Minute: {
                                text = formatDate(timestamp, 'HH:mm', exports.FormatDateType.XAxis);
                                break;
                            }
                            case TimeWeightConstants.Second: {
                                text = formatDate(timestamp, 'HH:mm:ss', exports.FormatDateType.XAxis);
                                break;
                            }
                            default: {
                                text = formatDate(timestamp, 'YYYY-MM-DD HH:mm', exports.FormatDateType.XAxis);
                                break;
                            }
                        }
                        ticks.push({
        ...
        if (isValid(this._topPane) && isValid(this._bottomPane)) {
            ...
            if (this._topPane.getOptions().state !== "minimize" /* PaneState.Minimize */ &&
                ...
                if (startDragReducedPaneHeight > reducedPaneMinHeight) {
                    ...
                    chart.getChartStore().executeAction(exports.ActionType.OnPaneDrag, { paneId: currentPane.getId() });
                    chart.layout({
                        measureHeight: true,
                        measureWidth: true,
                        update: true,
...
var ChartImp = /** @class */ (function () {
    ...
    ChartImp.prototype.crosshairChange = function (crosshair) {
        var _this = this;
        if (this._chartStore.hasAction(exports.ActionType.OnCrosshairChange)) {
            var indicatorData_1 = {};
            this._drawPanes.forEach(function (pane) {
                var id = pane.getId();
            ...
            if (isString(crosshair.paneId)) {
                this._chartStore.executeAction(exports.ActionType.OnCrosshairChange, __assign(__assign({}, crosshair), { indicatorData: indicatorData_1 }));
            }
        }
    };
